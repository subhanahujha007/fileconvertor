export default function PrivacyPolicy() {
    return (
        <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
            <p>Effective Date: 20 June 2025 </p>
            <p>
                At File Convertor, we are committed to safeguarding your privacy. This Privacy Policy outlines our practices
            ...
            <p>
                By using File Convertor, you agree to the practices outlined in this Privacy Policy. Please discontinue use of
